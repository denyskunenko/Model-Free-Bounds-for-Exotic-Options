...
% MOT_BOUNDS_CVX
% Two-marginal martingale optimal transport bounds using CVX.
%
% Payoff:
%       Phi_K(S1,S3) = max(S3 - K*S1,0)
%
% Inputs:
%       x,a : support and probabilities for mu1
%       z,b : support and probabilities for mu3
%       K   : forward-start strike multiplier
%
% Output fields include lower/upper bounds, optimal couplings,
% CVX status strings, and numerical residuals.
